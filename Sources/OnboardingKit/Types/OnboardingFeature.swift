    ...
    VStack {
        OnboardingFeatureView(
            OnboardingFeature(
                ...
                description: "Use a description that's short and gets to the point. No essays."
            )
        )
        OnboardingFeatureView(
            OnboardingFeature(
                ...
                description: "Reading a symbol is easier than reading a description."
            )
        )
        OnboardingFeatureView(
            OnboardingFeature(
        ...
        OnboardingFeatureView(
            OnboardingFeature(
                ...
                description: "It's incredibly easy to add onboardings in just a few extra lines!"
            )
        )
        OnboardingFeatureView(
            OnboardingFeature(
                ...
                description: "It's a view like the one found in Apple apps, combined with your app's look."
            )
        )
        OnboardingFeatureView(
            OnboardingFeature(
                ...
                description: "OnboardingKit has you covered with privacy, so you don't need to worry about it. (much)"
            )
        )
    }
    .padding(30)
